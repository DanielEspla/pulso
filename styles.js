export const styles = {
  ...
  timerHeroLabel: { color: "#F2B705", fontSize: 12, letterSpacing: 2, textTransform: "uppercase", margin: "0 0 6px" },
  timerHeroClock: { fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: 60, color: "#F5F5F0", margin: 0, lineHeight: 1 },
  timerHeroSub: { color: "#8A8F98", fontSize: 13, margin: "8px 0 0" },
  timerRingRow: { display: "flex", justifyContent: "center", gap: 10, marginTop: 18 },
  ringBtn: { width: 46, height: 46, borderRadius: "50%", border: "1px solid #2A2E38", background: "#12141A", color: "#F5F5F0", fontSize: 16, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" },

  dotsRow: { display: "flex", gap: 6, padding: "0 16px", marginBottom: 12 },
  dot: { flex: 1, height: 4, borderRadius: 2, background: "#2A2E38", border: "none", padding: 0, cursor: "pointer" },
  dotDone: { background: "#F2B705" },
  dotCurrent: { background: "#F2B705", opacity: 0.5 },

  focusCounter: { color: "#8A8F98", fontSize: 12, letterSpacing: 1, textTransform: "uppercase", margin: "0 16px" },
  focusExerciseName: { fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: 26, color: "#F5F5F0", margin: "4px 16px 16px", lineHeight: 1.15 },

  bigNumberGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, margin: "0 16px 12px" },
  bigNumberCard: { background: "#1C1F26", borderRadius: 14, padding: 16 },
  bigNumberVal: { fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: 30, color: "#F2B705", margin: 0 },
  bigNumberLabel: { color: "#8A8F98", fontSize: 12, marginTop: 2 },
  bigNumberTrend: { color: "#6FCF97", fontSize: 11, marginTop: 4 },

  streakBar: { margin: "0 16px 12px", background: "#1C1F26", borderRadius: 14, padding: 16, display: "flex", alignItems: "center", gap: 12 },
  streakFlame: { fontSize: 26 },
  streakTextBig: { fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: 17, color: "#F5F5F0" },
  streakTextSub: { color: "#8A8F98", fontSize: 12 },
  ...
  weekDayDotDone: { background: "#F2B705", color: "#1A1400" },
  weekDayDotRest: { background: "#2A2E38", color: "#8A8F98" },
  weekDayDotToday: { border: "2px solid #F2B705", color: "#F2B705" },
  weekDayLabel: { color: "#8A8F98", fontSize: 10 },
